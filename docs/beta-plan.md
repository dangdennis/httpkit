...
| 6 | Capacity, slow-client/overload stress, allocation profiles | Opt-in64-connection endpoint profile and1/16/64-slot admission/backlog runner implemented; slow-client matrix, sustained bounded-capacity proof, stable profiles, SQLite30min/PostgreSQL2h and idle/slow/overload30min campaigns pending |
