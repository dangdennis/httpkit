...
| 6 | Capacity, slow-client/overload stress, allocation profiles | Opt-in64-connection endpoint profile,1/16/64-slot admission/backlog and incomplete-input deadline/reset/shutdown runners implemented; blocked readers/unread bodies, sustained bounded-capacity proof, stable profiles, SQLite30min/PostgreSQL2h and idle/slow/overload30min campaigns pending |
