...
def source_hash():
    ...
    paths = [ROOT / 'dune', ROOT / 'dune-project', ROOT / 'http-kit-harness.opam',
             ROOT / 'dune-workspace', ROOT / 'dune-workspace.5.2']
    for directory in ['test', 'fuzz', 'tools', 'toolchain', '.github', 'dune.lock', 'dune.5.2.lock']:
...
def check():
    ...
    print(json.dumps({'milestone': 'M0', 'status': 'PASS' if ok else 'INFRA_ERROR',
